...
require_once realpath("../webservice/_comestoarra_connector_.php");
...
if ( ! $_SESSION['user_id'] && ! $_SESSION['user_name'] && ! $_SESSION['user_email'] ) :
    ...
    $output = json_encode(
                [ //create JSON data
                    ...
                    'messages' => 'Hey you JERK, piece of shit, and DUMB ASS -> Silence is Gold !'
                ]);
...
$config = array(
	...
	*/
	...
	'access_keys' => array( '213123hgljknuy1o_.9900-nNnjhkOPasdjjgd708hd32de0' ),
	...
	*/
	...
	'googledoc_file_exts'                     => array( 'pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx' ),
